## v5.012 — 2026-06-16
- Multi-giorno: FIX importante del raggruppamento. Lo "swap" introdotto in v5.011 e il criterio "tappa più vicina al gruppo" mescolavano valli diverse nello stesso giorno (es. Tione+Riva+Pergine+Egna+Cles), perché due valli a distanza simile da casa risultano "vicine" passando da casa. Ora: (1) rimosso lo swap; (2) accrescimento per COSTO DI INSERIMENTO (minuti di guida aggiunti al giro) con soglia "sulla via" (cost ≤ 1.2× distanza-da-casa della tappa): una tappa entra solo se è davvero sul corridoio del giorno, le altre valli restano per giorni diversi. Verificato col modello a stella (3 valli): ogni giornata = una sola valle, incluse le diramazioni di corridoio (Merano).
